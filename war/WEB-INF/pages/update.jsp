...
<body>
	...
	<div class="content-body">
		<div class="container">
			<div class="row">
				<h1 style="text-align: center;">更新博客</h1>
				<div style="width: 95%;">
					<label>请输入标题： </label><label id="needtitle"></label>
					<div style="text-align: center;">
						<input id="title" type="text" style="width: 100%;" value = "<%=blog.getTitle()%>" required></input>
					</div>
					<label>请选择标签： </label><label id="needcategory"></label>
					<div>
						<input list="categorylist" id="category" value = "<%=blog.getCategory()%>"/>
					...
					<div style="text-align: center;">
						<textarea id="description" name="message" rows="4" style="width: 100%;" required><%=blog.getDescription()%></textarea>
					</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("button").click(function() {
				...
				$.post("/update/<%=KeyFactory.keyToString(blog.getKey())%>", {
					title : $("#title").val(),
